...
class Expression:
    ...
    def evaluate(self):
        ...
        if self.op == Op.Neg:
            ...
            res = lambda a, b: a or b
        elif self.op == Op.And:
            res = lambda a, b: a and b
        elif self.op == Op.Imp:
            res = lambda a, b: (not a) or b
        else:
            res = lambda a, b: False
    ...
    def construct_table(self):
        ...
        for i in range(0, 2**mod_counter):
            for j in range(0, mod_counter):
                if i % 2**(j) == 0:
                    self.entities[mod_counter-1-j].truth = not self.entities[mod_counter-1-j].truth
            self.construct_row()
    ...
    for i in range(0, len(str)):
        ...
        if c is "(":
            ...
            if num_open == num_close:
                ...
                parts[index] += c
        elif c is "~" and i==0 and str[1] is "(":
            index += 1
            parts[index] += c
            index += 1
        elif c is not ">":
